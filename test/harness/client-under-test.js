...
.cp-tHead{display:grid;grid-template-columns:20px minmax(0,1fr) 110px 60px 56px;padding:6px 10px;background:var(--layer);border-bottom:1px solid var(--line);font-size:11px;color:var(--faint);align-items:center;}
.cp-tRow{display:grid;grid-template-columns:20px minmax(0,1fr) 110px 60px 56px;align-items:center;border-bottom:1px solid color-mix(in srgb,var(--line) 55%,transparent);padding:5px 10px;min-width:0;}
...
`;
    ...
    function ModelRow({ m, sel, onSelect }) {
      return e("button", {
        type: "button",
