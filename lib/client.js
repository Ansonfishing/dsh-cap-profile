...
.cp-cmpColName{font-family:var(--code);font-size:11px;color:var(--muted);text-align:right;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}
...
`;
    ...
    function ComparePane({ models, note, expanded, onToggleExpanded, onBack }) {
      ...
      const colHead = (corner, key) => e("div", { key, className: "cp-cmpGrid cp-cmpHead", style: gridStyle },
        ...
        models.map((m) => e("span", { key: m.id, className: "cp-cmpColName", title: m.id }, shortName(m)))
      );
      ...
      return e("div", null,
        ...
        days.length
          ? [
              ...
              e("div", { key: "cmp-trend", className: "cp-table" },
                ...
                days.map((d) => e("div", { key: d, className: "cp-cmpGrid cp-cmpRow" },
                  ...
                  models.map((m) => {
                    ...
                    return e("div", { key: m.id, className: "cp-tCell", title: d + " · 调用 " + num(s.calls) + " · 错误 " + num(er) },
                      e("div", { className: "cp-tBar" }, e("div", { className: "cp-tBarFill", style: { width: w + "%" } })),
